...
// Support info 0.3a 06.09.2017 (C) denbaster@gmail.com
...
#define LOCTEXT_NAMESPACE "FEditorModeExtensionEdModeToolkit"

FEditorModeExtensionEdModeToolkit::FEditorModeExtensionEdModeToolkit()
{
	UE_LOG(LogTemp, Log, TEXT("===================Open Export OverrideVertexColor Toolkit==================="));
	StoredColors.Empty();
	PtrOutInt = MakeShareable(new uint32(911));
}
void FEditorModeExtensionEdModeToolkit::Init(const TSharedPtr< class IToolkitHost >& InitToolkitHost) //Init auto start after construct always
{
	UE_LOG(LogTemp, Log, TEXT("Init Block!"));

	OVCTextChangedEvent.AddRaw(this, &FEditorModeExtensionEdModeToolkit::Test); 	// Assign on Event

	ChildSlot[
		SAssignNew(ToolkitWidget, SBorder)
			.IsEnabled(&FEditorModeExtensionEdModeToolkit::IsWidgetEnabled)
			[
					...
					[
						...
						[
							...
							+ SHorizontalBox::Slot()
								...
								[
									SNew(SButton)
									.OnClicked(this,&FEditorModeExtensionEdModeToolkit::FindOVCButtonClicked)
									[
				...
				*/
				+ SVerticalBox::Slot()
					...
					[
						...
						.OnClicked(this,&FEditorModeExtensionEdModeToolkit::OnButtonClickExportOVC, PtrOutInt)
					]
				+ SVerticalBox::Slot()
					.HAlign(HAlign_Left)
					.AutoHeight()
					[
						...
						.OnClicked(this,&FEditorModeExtensionEdModeToolkit::OnButtonClickImportOVC, PtrOutInt)
					]
			]
	];
...
void FEditorModeExtensionEdModeToolkit::Test()
{
	UE_LOG(LogTemp, Log, TEXT("test event"));
}

FReply FEditorModeExtensionEdModeToolkit::TestOVCButtonClicked()
{
...
// Dialogs Menu
FReply FEditorModeExtensionEdModeToolkit::FindOVCButtonClicked() 
{
...
void FEditorModeExtensionEdModeToolkit::SaveOVCButtonClicked()
{
	TArray<FString> OpenFilenames;
	IDesktopPlatform* DesktopPlatform = FDesktopPlatformModule::Get();
	bool bOpened = false;
...
FReply FEditorModeExtensionEdModeToolkit::OnButtonClickExportOVC(TSharedPtr<uint32> num)
{
...
FReply FEditorModeExtensionEdModeToolkit::OnButtonClickImportOVC(TSharedPtr<uint32> num)
{
...
TArray<FColor> FEditorModeExtensionEdModeToolkit::CopyInstanceVertexColors()
{
...
void FEditorModeExtensionEdModeToolkit::FillVertexColorsAllLODs(TArray<FColor>& InColors, FString FileName)
{
	USelection& SelectedActors = *GEditor->GetSelectedActors();
	if (SelectedActors.Num() != 1)
	{
...
void FEditorModeExtensionEdModeToolkit::FillVertexColorsToActor(AActor* LevelActor,TArray<FColor>& InColors)
{
...
FName FEditorModeExtensionEdModeToolkit::GetToolkitFName() const
{
	return FName("VertexActorEditorMode");
}

FText FEditorModeExtensionEdModeToolkit::GetBaseToolkitName() const
{
	return NSLOCTEXT("VertexActorEditorModeToolkit", "DisplayName", "VertexActorEditorEdMode Tool");
}

class FEdMode* FEditorModeExtensionEdModeToolkit::GetEditorMode() const
{
	return GLevelEditorModeTools().GetActiveMode(FEditorModeExtensionEdMode::EM_EditorModeExtensionEdModeId);
}

/** SaveLoad Section*/
bool FEditorModeExtensionEdModeToolkit::SaveDataToFile(const FString& FullFilePath, FBufferArchive& ToBinary)
{
...
TArray<uint8> FEditorModeExtensionEdModeToolkit::LoadDataFromFile(const FString& FullFilePath)
{
...
FString FEditorModeExtensionEdModeToolkit::ActorGetUniqueID(AActor* A)
{
